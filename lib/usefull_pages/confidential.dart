  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarModel().loadAppBar(
          context, 'Confidențialitate', Icons.add_box_outlined, _scaffoldKey),
      body: SingleChildScrollView(
        padding: EdgeInsets.all(20.0),
        child: Column(
          children: <Widget>[
            //1
            WidgetConfidentialModel().widgetTitleParagraph('Termeni de confidențialitate'),
            ...
            WidgetConfidentialModel().widgetRichText(
              'Aplicația este un instrument mobil de facilitare a comunicării dintre localnici, instituțiile locale și ' +
                ...
                [
                  WidgetConfidentialModel().widgetTextSpanLink('https://policies.google.com/privacy', 'https://policies.google.com/privacy'),
                  TextSpan(
                      text: '). ' +
            ...
            WidgetConfidentialModel().widgetRichText(
                ...
                [
                  WidgetConfidentialModel().widgetTextSpanLink('relatiipublice@primariaradauti.ro', 'mailto:relatiipublice@primariaradauti.ro'),
                  TextSpan(text: ', '),
                  WidgetConfidentialModel().widgetTextSpanLink('office@serviciicomunale.ro', 'mailto:office@serviciicomunale.ro'),
                  TextSpan(text: ', '),
                  WidgetConfidentialModel().widgetTextSpanLink('agentia.radauti@acetsv.ro', 'mailto:agentia.radauti@acetsv.ro'),
                  TextSpan(text: ', '),
                  WidgetConfidentialModel().widgetTextSpanLink('contact@cjsuceava.ro', 'mailto:contact@cjsuceava.ro'),
                  TextSpan(text: ', '),
                  WidgetConfidentialModel().widgetTextSpanLink('cjsuceava@gnm.ro', 'mailto:cjsuceava@gnm.ro'),
                  TextSpan(text: ', '),
                  WidgetConfidentialModel().widgetTextSpanLink('gardaforestiera.suceava@gmail.com', 'mailto:gardaforestiera.suceava@gmail.com'),
                  TextSpan(
            ...
            //2
            WidgetConfidentialModel().widgetTitleParagraph('Colectarea și folosirea informațiilor'),
            WidgetConfidentialModel().widgetParagraph(
            ...
            //3
            WidgetConfidentialModel().widgetTitleParagraph('Servicii Google Play'),
            WidgetConfidentialModel().widgetSubtitleParagraph('Logarea datelor', context),
            WidgetConfidentialModel().widgetParagraph(
            ...
            WidgetConfidentialModel().widgetSubtitleParagraph('Cookies', context),
            WidgetConfidentialModel().widgetParagraph(
            ...
            //4
            WidgetConfidentialModel().widgetTitleParagraph('Provideri de serviciu'),
            WidgetConfidentialModel().widgetParagraph(
            ...
            //7
            WidgetConfidentialModel().widgetTitleParagraph('Link-uri către alte site-uri sau către alți provideri de serviciu'),
            WidgetConfidentialModel().widgetParagraph(
            ...
            //8
            WidgetConfidentialModel().widgetTitleParagraph('Confidențialitatea copiilor'),
            WidgetConfidentialModel().widgetParagraph(
            ...
            //9
            WidgetConfidentialModel().widgetTitleParagraph('Schimbări în politica de confidentialitate'),
            WidgetConfidentialModel().widgetParagraph(
