      ...
      child: TextField(
        ...
        decoration: new InputDecoration(
          ...
          enabledBorder: OutlineInputBorder(
            borderSide: BorderSide(width: 1, color: Color(0xFF38A49C)),
          ),
  ...
  Widget widgetTextField(_controller, _validate) {
    return Container(
      ...
      child: TextField(
        ...
        decoration: new InputDecoration(
          border: new OutlineInputBorder(
            borderSide: new BorderSide(color: Color.fromRGBO(56, 164, 156, 10)),
          ),
          labelText: 'Mesaj:',
          labelStyle: TextStyle(
            color: Colors.grey,
          ...
          enabledBorder: OutlineInputBorder(
            borderSide:
                BorderSide(width: 1, color: Color.fromRGBO(56, 164, 156, 10)),
          ),
          focusedBorder: OutlineInputBorder(
            borderSide:
                BorderSide(width: 1, color: Color.fromRGBO(56, 164, 156, 10)),
