...
class EventDetailsContent extends StatefulWidget {
  EventDetailsContentState createState() => EventDetailsContentState();
}
class EventDetailsContentState extends State<EventDetailsContent>{
  List fd;
  Map fi;
...
class EventDetailsContent2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final event = Provider.of<Event>(context);
    final screenWidth = MediaQuery.of(context).size.width;
