                                              ...
                                              child: Consumer<AppState>(
                                                builder: (context, appState, _) => Column(
                                                  children: <Widget>[
                                                    ...
                                                    for(final event in snapshot.data.where((e) => DateTime.utc(e.yearT, e.monthT, e.dayT).isAfter(DateTime.utc(2020, 3, 14)) || DateTime.utc(e.yearT, e.monthT, e.dayT).isAtSameMomentAs(DateTime.utc(2020, 3, 14)) ))
