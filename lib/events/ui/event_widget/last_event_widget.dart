...
class LastEventWidget extends StatelessWidget {
  ...
  const LastEventWidget({Key key, this.event, this.fontSizeTextRow1Column1, this.fontSizeTextRow2Column1, this.fontSizeTextRow3Column1, this.fontSizeTextRowIconColumn3, this.sizeIconRowIconColumn3, this.fontSizeTextTitleRowColumn3, this.widthObject,}) : super(key: key);
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      WidgetEventModel().column3(event, context, Container(), fontSizeTextTitleRowColumn3, sizeIconRowIconColumn3, fontSizeTextRowIconColumn3),
                    ],
                  ),
                ),
