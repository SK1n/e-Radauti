...
class NewEventsController extends BaseController<List<EventsItemModel2>> {
  Future<void> getEvents() async {
    ...
    futurize(() async {
      ...
      List<EventsItemModel2> sortedList = data.events;
      for (EventsItemModel2 item in sortedList) {
