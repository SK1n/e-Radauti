Map<String, String> roRO = {
  ...
  "e-radauti": "e-Rădăuți",
  "about-us-app-description": "Aplicația „e-Rădăuți” este un proiect voluntar născut în 2017 din dorința de a duce orașul mai aproape de era digitală, de a facilita implicare localnicilor în acțiunile locale."
      "\nAplicația s-a născut în urma unui concurs în premieră în oraș intitulat „Hai să digitalizăm orașul” la care au participat optsprezece elevi din două licee din Rădăuți."
      "\nAplicațiile dezvoltate în timpul concursului au fost evaluate de un juriu internațional de profesioniști în domeniul IT și Design iar resursele financiare pentru premii au venit din donații ale membrilor „Rădăuțiul Civic”, ale juriului și ale firmei locale „Hard Power Services”."
      "\nNoua versiune a aplicației e-Rădăuți este implementată în anul 2020 cu ajutorul fondurilor obținute de la asociația Geeks for Democracy, prin Fondul pentru Democrație și este dedicată doar localnicilor, renunțând temporar la partea dedicată turiștilor."
      "\nDe asemenea această versiune a fost actualizată cu sprijinul oferit de Code4Romania, în cadrul ședințelor tehnice Civic Tech 911"
      "\nAcest upgrade a venit cu noi funcționalități dar și cu îmbunătățiri ale funcționalităților deja existente, aplicația fiind disponibilă în premieră și pe iOS, nu doar pe Android."
  ...
  "privacy-terms": "Termeni de confidențialitate",
  "contact-us": "Contactează-ne",
  "contact-us-description":
      "Dacă ai întrebări sau sugestii referitoare la termenii noștri de confidențialitate, nu ezita să ne contactezi la adresa radautiulcivic@gmail.com.Tot pe această adresă de e-mail ne puteți solicita ștergerea datelor personale din baza noastră de date. ",
  "changes-privacy": "Schimbări în politica de confidentialitate",
  "changes-privacy-description":
      "Ori de câte ori va fi necesar, vom putea actualiza politica noastră de confidențialitate. În consecință te sfătuim să revii pe această pagină periodic în caz că apar unele schimbări. Vei primi notificări când vor apărea modificări în politica noastră de confidențialitate. Aceste schimbări intră în vigoare imediat ce sunt postate pe această pagină.",
  "child-privacy": "Confidențialitatea copiilor",
  ...
  "security-description":
      'Apreciem încrederea ta atunci când ne oferi informații personale. De aceea încercăm să folosim mijloace acceptabile din punct de vedere comercial ca să o protejăm. Cu toate acestea, trebuie să ții cont că nicio metodă de transmisie prin internet sau de stocare electronică nu este 100% sigură, și nu putem garanta securitatea ei absolută.'
  ...
  "service-providers": "Provideri de serviciu",
